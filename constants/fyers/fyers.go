...
const GenerateAuthCodeURL string = "/generate-authcode?client_id=##CLIENT_ID##&redirect_uri=##REDIRECT_URI##&response_type=code&state=##STATE##"
...
const AdminTelegramUserID int64 = 0
